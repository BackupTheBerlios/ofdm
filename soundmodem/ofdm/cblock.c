...
void enc_cblock(unsigned *cblock, int len, int lvl, int fecrate)
{
...
int dec_cblock(unsigned char data[DataCarriers], int *len, int *lvl, int *fecrate)
{
